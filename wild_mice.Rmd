...
total.n.otus <- ncol(otu.med)
otu.distribution <- quantile(otu.alpha$sobs, c(0.025, 0.50, 0.975))
present90 <- apply(otu.med>0, 2, sum) >= 0.90*nrow(otu.med)
notus.present90 <- sum(present90)
otu.present90 <- colnames(otu.med)[present90]
otu_names.present90 <- levels(factor(otu.taxa[otu.present90]))
otu.percent.present90 <- 100 * sum(otu.med[,present90])/nrow(otu.med)
notus.presentAll <- sum(apply(otu.med>0, 2, sum) == nrow(otu.med))
...
present90 <- apply(phylo.med>0, 2, sum) >= 0.90*nrow(phylo.med)
nphylo.present90 <- sum(apply(phylo.med>0, 2, sum) >= 0.90*nrow(phylo.med))
phylo.percent.present90 <- 100 * sum(phylo.med[,present90])/sum(phylo.med)

presentAll <- apply(phylo.med>0, 2, sum) == nrow(phylo.med)
nphylo.presentAll <- sum(presentAll)
phylo.percent.presentAll <- 100 * sum(phylo.med[,presentAll])/sum(phylo.med)
