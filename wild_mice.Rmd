...
```{r figure2, height=4, width=7.5, warning=FALSE, fig.align='center', tidy=TRUE}
...
#look at difference in variationd within and between sampling stations
...
```{r figure5, fig.width=9, fig.height=6}
