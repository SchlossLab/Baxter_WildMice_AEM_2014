...
```{r}
location.thetayc <- mantel(thetayc, distance.matrix, method="spearman", permutations=1e4)
location.thetayc
...
location.weighted <- mantel(weighted, distance.matrix, method="spearman", permutations=1e4)
location.weighted
