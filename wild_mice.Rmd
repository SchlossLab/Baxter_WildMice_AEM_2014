...
```{r}
total.n.otus <- ncol(otu.subsampled)
otu.distribution <- quantile(otu.alpha$sobs, c(0.025, 0.50, 0.975))
present90 <- apply(otu.subsampled>0, 2, sum) >= 0.90*nrow(otu.subsampled)
notus.present90 <- sum(apply(otu.subsampled>0, 2, sum) >= 0.90*nrow(otu.subsampled))
otu.present90 <- colnames(otu.subsampled)[present90]
otu_names.present90 <- levels(factor(otu.taxa[otu.present90]))
otu.percent.present90 <- 100 * sum(otu.subsampled[,present90])/sum(otu.subsampled)
notus.presentAll <- sum(apply(otu.subsampled>0, 2, sum) == nrow(otu.subsampled))
...
total.n.phylos <- ncol(phylo.subsampled)
#phylo.distribution <- quantile(phylo.alpha$sobs, c(0.025, 0.50, 0.975))
present90 <- apply(phylo.subsampled>0, 2, sum) >= 0.90*nrow(phylo.subsampled)
nphylo.present90 <- sum(apply(phylo.subsampled>0, 2, sum) >= 0.90*nrow(phylo.subsampled))
#phylo.present90 <- colnames(phylo.subsampled)[present90]
#phylo_names.present90 <- levels(factor(phylo.taxa[phylo.present90]))
phylo.percent.present90 <- 100 * sum(phylo.subsampled[,present90])/sum(phylo.subsampled)

presentAll <- apply(phylo.subsampled>0, 2, sum) == nrow(phylo.subsampled)
nphylo.presentAll <- sum(presentAll)
phylo.percent.presentAll <- 100 * sum(phylo.subsampled[,presentAll])/sum(phylo.subsampled)

dominant.phylo <- colnames(phylo.subsampled)[apply(phylo.subsampled, 1, which.max)]
