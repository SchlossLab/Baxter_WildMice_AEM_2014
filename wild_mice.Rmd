...
```{r knitr.settings, eval=TRUE, echo=TRUE, cache=FALSE}
...
```{r figure2, height=4, width=7.5, dev="png"}
...
```{r figure3, fig.width=8.5, fig.height=6.5, dev="png"}
...
```{r figure4, fig.width=6, fig.height=4, dev="png"}
...
```{r figure5, fig.width=9, fig.height=6, fig.cap="Figure 5. Something clever", dev="png"}
...
par(mar=c(6, 5, 0.5, 0.5))
stripchart(at=1, thetayc.same_different$same, vertical=T, method="jitter", jitter=0.3, xlim=c(0.5,2.5), ylim=c(0,1.0), yaxt="n", pch=15, ylab="Median distance")
stripchart(at=2, thetayc.same_different$different, vertical=T, method="jitter", jitter=0.3, add=T, pch=15, col="red")
...
par(mar=c(6,5,0.5, 0.5))
plot(x=x.within, y=median.within, ylim=c(0,1), xlim=c(0,35), pch=15, xlab="Days between samples", ylab="Distance", yaxt="n")
...
legend(x=25, y=0.15, legend=c("Intra-animal", "Inter-animal"), pch=15, col=c("black", "red"))
