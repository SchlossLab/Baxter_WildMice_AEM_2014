...
mothur "#
  ...
  get.communitytype(shared=16S.analysis/wild_mice.16S.trim.contigs.unique.good.good.filter.unique.precluster.pick.pds.wang.pick.tx.1.subsample.shared)
"
```
...
thetayc.adonis <- adonis(thetayc~md$SP*md$Sex, strata=md$ET, perm=1e4)
thetayc.adonis
...
weighted.adonis <- adonis(weighted~md$SP*md$Sex, strata=md$ET, perm=1e4)
weighted.adonis
