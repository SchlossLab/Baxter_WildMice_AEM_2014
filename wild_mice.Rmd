...
We'll also need to get ahold of some reference files. First we'll get the SILVA-based bacterial and eukaryotic reference alignment and trim it to the V4 region of the 16S rRNA gene.
