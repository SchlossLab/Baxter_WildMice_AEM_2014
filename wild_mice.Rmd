...
theta.food.mantel <- mantel(theta.food, food, method="spearman", permutations=1e4)
theta.food.mantel
...
weighted.food.mantel <- mantel(weighted.food, food, method="spearman", permutations=1e4)
...
#run random forest
data.rf <- randomForest(x=bact.fb, y=food.dmm.design$V2, importance=TRUE, proximity=TRUE, ntree=1e4) 
